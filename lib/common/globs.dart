...
import 'package:ahaar_project/main.dart';

class Globs {
  static const appName = "Ahaar";
  ...
  // Firebase Authentication Utility Methods
  ...
  static Future<DocumentSnapshot?> getDataFromFirestore(
  ...
  static Future<void> deleteDataFromFirestore(
      String collection, String docId) async {
    try {
      await FirebaseFirestore.instance
          .collection(collection)
