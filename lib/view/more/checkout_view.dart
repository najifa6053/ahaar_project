...
class _CheckoutViewState extends State<CheckoutView> {
  List paymentArr = [
    ...
    {"name": "test@gmail.com", "icon": "assets/img/BKash.png"},
  ];
  ...
  Future<void> saveOrderDetails() async {
    try {
      ...
      final orderDetails = {
        ...
        "paymentMethod": selectMethod == -1
            ? "Not Selected"
            : paymentArr[selectMethod]["name"],
        "subTotal": 68,
        "deliveryCost": 2,
        "discount": 4,
        "total": 66,
      ...
      // Show the checkout message view
